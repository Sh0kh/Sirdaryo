...
export default function PersonCreate({ isOpen, onClose, refresh }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await axios.post(`/article/create`, data, {
                headers: {
                ...
                <div className="mt-[10px]">
                    ...
                    <div className="flex items-center justify-between gap-[10px] mt-[10px] w-full">
                        ...
                        <Input
                            ...
                            onChange={handleChange}
                            inputText={"Majburiyat (узб)"} placeholder={"...."} />
                    </div>
                    <div className="flex items-center justify-between gap-[10px] mt-[10px] w-full">
                        <Input
                            ...
                            onChange={handleChange}
                            inputText={"Majburiyat (Oz)"} placeholder={"...."} />
                        <Input
                            name='activityLATIN'
                            value={formData?.activityLATIN}
                            onChange={handleChange}
                            inputText={"Faoliyat  (Oz)"} placeholder={"...."} />
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-[10px] mt-[10px] w-full">
                        ...
                        <TextArea
                            ...
                            onChange={handleChange}
                            inputText={"Malumot (Oz)"} placeholder={"...."} />
                    </div>
